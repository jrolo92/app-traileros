...
import { IonList, IonListHeader, IonItem, IonLabel, IonToggle, IonInput, IonFab, IonFabButton, IonIcon, IonCard, IonImg, IonAvatar, IonButton, IonBadge } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonBadge, IonButton, IonAvatar, IonIcon, CommonModule, FormsModule, ReactiveFormsModule, IonList, IonListHeader, IonItem, IonLabel, IonToggle, IonInput, FooterComponent ]
})
